...
// const IMAGES = [
//   { id: 1, url: casaTangram },
//   { id: 2, url: "/media/tangram2.png" },
// ];
...
//     const newPieces = [...piecesState];
//     const droppedPiece = newPieces.find(piece => piece.id === parseInt(id));
//     const boardRect = boardRef.current.getBoundingClientRect();
    
//     // Coloca la pieza en el centro del tablero
//     droppedPiece.x = boardRect.width / 2 - 40; // 40 es el tamaño de la pieza dividido por 2
//     droppedPiece.y = boardRect.height / 2 - 40; // Ajusta según el tamaño de la pieza
...
//       ...prevRotation,
//       [id]: (prevRotation[id] || 0) + 45, // Incrementa 90 grados de rotación
//     }));
//   };

//   return (
//     <div className="flex h-screen">
//       {/* Contenedor de piezas alineado a la izquierda */}
...
//               style={{
//                 transform: `rotate(${rotation[piece.id] || 0}deg)`, // Aplica la rotación
//               }}
//             />
//             {isPlaying && (
//               <button
...
//           >
//             {currentIndex < IMAGES.length - 1 ? "Siguiente" : "Terminar"}
//           </button>
//         </div>
//       </div>
...
// const PIECES = [
//   { id: 0, image: TriangleYellowSVG, x: 0, y: 0 },
//   { id: 1, image: TriangleBlueSVG, x: 0, y: 0 },
//   { id: 2, image: TrianglePurpleSVG, x: 0, y: 0 },
//   { id: 3, image: TrianglePinkSVG, x: 0, y: 0 },
//   { id: 4, image: TriangleGreenSVG, x: 0, y: 0 },
//   { id: 5, image: SquareSVG, x: 0, y: 0 },
//   { id: 6, image: ParallelogramSVG, x: 0, y: 0 },
// ];
...
//   const handleDrop = (e) => {
//     const id = e.dataTransfer.getData("id");
//     const droppedPiece = piecesState.find(piece => piece.id === parseInt(id));

//     // Verifica que la pieza esté dentro del área del tablero
//     const boardRect = boardRef.current.getBoundingClientRect();
//     const pieceRect = e.target.getBoundingClientRect();
    
//     // Si está dentro, se mueve al tablero
//     if (
...
//     ) {
//       setPiecesState(piecesState.filter(piece => piece.id !== droppedPiece.id));
//       setBoardPieces([
//         ...boardPieces,
//         { ...droppedPiece, x: e.clientX - boardRect.left, y: e.clientY - boardRect.top }
//       ]);
//     }
//   };
...
//     setRotation((prevRotation) => ({
//       ...prevRotation,
//       [id]: (prevRotation[id] || 0) + 90, // Incrementa 90 grados de rotación
//     }));
//   };
...
//               alt={`Tangram piece ${piece.id}`}
//               className="w-16 h-16 cursor-pointer"
//               onClick={() => handleRotate(piece.id)} // Rotar pieza al hacer clic
//             />
//           </div>
//         ))}
